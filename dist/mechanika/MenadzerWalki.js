...
exports.MenadzerWalki = void 0;
class MenadzerWalki {
    constructor(wczytywaczMapy) {
        this.wczytywaczMapy = wczytywaczMapy;
    }
    obliczModyfikatory(atakujacy, obronca) {
    ...
    obliczPrzewageLiczebna(atakujacy, obronca) {
    ...
    obliczModyfikatorPogody(teren) {
        if (!teren?.pogodaEffekt)
            return 0;
        // TODO: Implementacja wpływu pogody
        return 0;
    }
    obliczModyfikatorPoryDoby() {
        // TODO: Implementacja wpływu pory doby
        return 0;
    }
    obliczModyfikatorZaopatrzenia(atakujacy, obronca) {
    ...
    obliczModyfikatorMorale(atakujacy, obronca) {
        return (atakujacy.stats.morale - obronca.stats.morale) / 100;
    }
    obliczModyfikatorDoswiadczenia(atakujacy, obronca) {
        return (atakujacy.stats.doswiadczenie - obronca.stats.doswiadczenie) / 100;
    }
    rozstrzygnijWalke(atakujacy, obronca) {
    ...
    aktualizujStanJednostek(atakujacy, obronca, wynik) {
    ...
    wyswietlWynikWalki(atakujacy, obronca, wynik) {
        console.log("\nWynik walki:", {
            atakujacy: {
                id: atakujacy.id,
...
exports.MenadzerWalki = MenadzerWalki;
